...
| [`docs/MOVING-TO-ANOTHER-PC.md`](docs/MOVING-TO-ANOTHER-PC.md) | Moving the system to a different computer, or onto a new router and a new IP address, without losing the fingerprints and the terminals |
